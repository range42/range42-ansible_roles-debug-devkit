...
#      flag must read 0, the MAC must not have changed, no key may be lost, and the running
#      guest must agree (a deferred change filters still until the guest reboots, and still blocks MAC spoofing)
#
